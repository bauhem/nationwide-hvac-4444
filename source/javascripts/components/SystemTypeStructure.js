    ...
    return (
      <>
        ...
        <div className="div-flex-h">
          ...
          {this.systemType('Packaged System', "Packaged Systems have both the condensing and air handling unit inside one system. The unit will usually be attached to the side of your home, on the roof, or sometimes on a raised stand.", 'packaged_system')}
